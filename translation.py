...
ᴛʜɪs ʙᴏᴛ ɪs ᴘᴏᴡᴇʀᴇᴅ ʙʏ <a href="https://t.me/Lordsakunaa">Admin</a></b>
"""
...
🌀 ᴄʜᴀɴɴᴇʟ : <a href="https://t.me/purplebotz">PURPLE BOTZ</a>
...
👲 ᴅᴇᴠᴇʟᴏᴘᴇʀ : <a href="https://t.me/Lordsakunaa">Admin</a></b>
...
"""
    ...
    TECH_VJ_START_BUTTONS = InlineKeyboardMarkup(
        [[
            ...
            InlineKeyboardButton('🔍 MOVIES 🍿', url='https://t.me/ezpzsupport/18'),
            InlineKeyboardButton('💕 CHATTING GROUP 💕', url='https://t.me/ezpzsupport/9')
        ], [
            InlineKeyboardButton('❓ ʜᴇʟᴘ', callback_data='help'),
            InlineKeyboardButton('🦊 ᴀʙᴏᴜᴛ', callback_data='about')
        ], [
            InlineKeyboardButton('😍 Watch Movies 😍', url='https://t.me/ezpzsupport/18')
        ]]
    )
    TECH_VJ_HELP_BUTTONS = InlineKeyboardMarkup(
        [[
            InlineKeyboardButton(' sᴜʙsᴄʀɪʙᴇ DEVELOPER', url='https://youtube.com/@Tech_VJ')
        ], [
            InlineKeyboardButton('🔍 sᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ', url='https://t.me/purplebotz'),
            InlineKeyboardButton('🤖 ᴜᴘᴅᴀᴛᴇ ᴄʜᴀɴɴᴇʟ', url='https://t.me/purpleebots')
        ], [
